...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=160, lr=0.1, lr_min=1e-4, lr_factor=10, lr_patience=8, clipgrad=10000,
        ...
        aux_trn_ldr, _, aux_val_ldr = get_loaders([self.aux_dataset], nc_first_task=None,
                                                     batch_size=self.aux_batch_size, num_workers=4, pin_memory=False)

        self.aux_trn_loader = aux_trn_ldr
        self.aux_val_loader = aux_val_ldr
...
class StudentTrainer(Inc_Learning_Appr):
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            loss, final_targets = self.criterion(t, outputs, targets_old, targets_new)
            # Backward
    ...
    def eval(self, t, val_loader):
        with torch.no_grad():
            ...
            for images, targets in val_loader:
                ...
                predicted += list(outputs)
        return total_loss / total_num, -1, -1, outputs, targets_new
    ...
    def criterion(self, t, outputs, targets_old, targets_new=None):
        ...
        return torch.nn.functional.mse_loss(torch.cat(outputs, dim=1), targets.detach(), reduction='mean'), targets.detach()

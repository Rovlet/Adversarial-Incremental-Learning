...
class Appr(Inc_Learning_Appr):
    ...
    def extra_parser(args):
        ...
        parser.add_argument('--K', default=1, type=int, required=False,
        ...
        if ref_outputs is None or ref_features is None:
            ...
            if self.margin_ranking:
                ...
                if hard_num > 0:
                    ...
                    max_novel_scores = outputs_wos[hard_index, num_old_classes:]
                    max_novel_scores = max_novel_scores
                    max_novel_scores = max_novel_scores[0]
